...
CONFIG_PATH = os.path.join(ABS_PATH, "config_friction_Dec07_rho_eps_low")
mode='igraph'
sim_num = 3

config_fname = os.path.join(CONFIG_PATH, 'all_configs.json')
exp_type = "vary_friction_and_learning_and_trunc"
# get network names corresponding to the strategy
EXPS = json.load(open(config_fname,'r'))[exp_type]

EXP_NAMES = list(EXPS.keys())#[-2:]
RUN_PATH = f'08122022_friction_{exp_type}_{sim_num}_runs_loweps'
