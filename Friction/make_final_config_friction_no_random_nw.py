...
def make_exps(saving_dir, default_infosys_config):
    ...
    LEARNING_FRICTION =  sorted(list([0,0.01,0.05,0.1])+list(np.arange(.2, .9, .5))+[1])
    MU_FRICTION = sorted(list([0.01,0.05,0.1])+list(np.arange(.2, .9, .5))+[1])#MU_FRICTION = sorted(list([0.01,0.05,0.1])+list(np.arange(.2, .9, .5))+[1])MU_FRICTION = sorted(list([0.01,0.05,0.1])+list(np.arange(.2, .9, .3))+[1])#sorted(list([0.01,0.05,0.1])+list(np.arange(.2, 1.1, .1)))#sorted(list([0.01,0.05,0.1])+list(np.arange(.2, 1.1, .1)))
...
if __name__=='__main__':
    ...
    saving_dir = os.path.join(ABS_PATH, "Friction/config_friction_Dec07_rho_eps_low")
